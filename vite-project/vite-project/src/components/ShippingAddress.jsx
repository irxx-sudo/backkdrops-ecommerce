...
export default function ShippingAddress({ session }) {
  ...
  const save = () => {
    ...
    saveAll(all)
    setSavedMsg('Demo: shipping address saved for this account.')
    ...
    <section id="shipping" className="section sectionAlt">
      <div className="sectionHeader">
        <div>
          ...
          <p className="sectionSubtitle">Demo checkout: save once and reuse later.</p>
        </div>
      </div>
      ...
      <div className="shippingCard glass">
        <div className="shippingGrid">
          <div className="field">
            <label className="label" htmlFor="shipName">Full name</label>
            <input id="shipName" className="input" value={form.fullName} onChange={update('fullName')} />
          </div>

          <div className="field">
            <label className="label" htmlFor="shipPhone">Phone</label>
            <input id="shipPhone" className="input" value={form.phone} onChange={update('phone')} placeholder="e.g. +1 555 0100" />
          </div>

          <div className="field shippingSpan2">
            <label className="label" htmlFor="ship1">Address line 1</label>
            <input id="ship1" className="input" value={form.address1} onChange={update('address1')} />
          </div>

          <div className="field shippingSpan2">
            <label className="label" htmlFor="ship2">Address line 2 (optional)</label>
          ...
          <div className="field">
            <label className="label" htmlFor="shipZip">Postal code</label>
            <input id="shipZip" className="input" value={form.postalCode} onChange={update('postalCode')} />
          </div>

          <div className="field">
            <label className="label" htmlFor="shipCountry">Country</label>
